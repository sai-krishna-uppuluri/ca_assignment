...
import '../styles/KnowledgeStyles.css'
import Image from 'next/image'
import knowledgeImage from '../public/4.jpg'

export default function KnowledgeSection() {
  return (
    <div className='uni-padding knowledge-con'>
      <div className='knowledge-image-con'>
        <Image src={knowledgeImage} width={500} height={50} alt='business-section' className='knowledge-image'/>
      </div>
      <div className='knowledge-text-con'>
        <h3>We are a full service New-age CA firm, with our office in Bangalore, India</h3>
        <p className='knowledge-para-text'>
